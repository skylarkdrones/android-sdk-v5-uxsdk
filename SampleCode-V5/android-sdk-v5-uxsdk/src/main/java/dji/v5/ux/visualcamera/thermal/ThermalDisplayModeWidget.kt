...
open class ThermalDisplayModeWidget @JvmOverloads constructor(
    context: Context,
    ...
    private val widgetModel by lazy {
        ThermalDisplayModeWidgetModel(DJISDKModel.getInstance(), ObservableInMemoryKeyedStore.getInstance())
    }
