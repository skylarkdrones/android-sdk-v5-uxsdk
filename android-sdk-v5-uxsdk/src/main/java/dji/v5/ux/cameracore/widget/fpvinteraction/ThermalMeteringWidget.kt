...
import dji.v5.ux.databinding.UxsdkThermalFocusViewBinding
...
class ThermalMeteringWidget : ConstraintLayoutWidget<Any>, ICameraIndex {
    ...
    private lateinit var binding: UxsdkThermalFocusViewBinding
    ...
    override fun initView(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        binding = UxsdkThermalFocusViewBinding.inflate(LayoutInflater.from(context), this, true)
    ...
    override fun reactToModelChanges() {
        addReaction(widgetModel!!.temperatureProcessor.toFlowable()
            .observeOn(ui())
            .subscribe {
                binding.tempTv.text = formatTemperature(it)
            }
        )
        ...
        addReaction(widgetModel!!.isSBSOnProcessor.toFlowable()
            .observeOn(ui())
            .subscribe {
                binding.thermalSpotGroup.visibility = View.GONE
            })
    }
    ...
    fun clickEvent(
        ...
        binding.thermalSpotGroup.visibility = View.VISIBLE
